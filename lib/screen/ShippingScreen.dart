                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Row(
                        ...
                        children: [
                          Text("ADD PAYMENT DETAILS",style: TextStyle(color: Colors.white),),
                          SizedBox(
                            width: 16,
                          ),
      ...
      child:       Row(
        ...
        children: [
          Padding(
              ...
              child: result.menuimage.isEmpty?Image.asset(
                Res.ic_poha,
                width: 60,
                height: 60,
              ):Image.network(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          result.deliveryDate+"/"+result.deliveryFromtime+"/"+result.deliveryTotime,
                          style: TextStyle(
