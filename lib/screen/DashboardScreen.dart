...
class DashboardScreen extends StatefulWidget {
  ...
  var max;
  var mealPlan;
  DashboardScreen(this.mealfor, this.cuisine, this.mealPlan, this.type, this.min, this.max);
...
class _DashboardScreenState extends State<DashboardScreen> {
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text("abc street  East wave 4.1 mi via ")
                        ],
                      ),
                    ),
                    Row(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                  ...
                                  child: Image.asset(Res.ic_filter,width: 50,height: 50,)),
                            )),
                          ),
                        )
                      ],
                    ...
                    child: Padding(
                        ...
                        child:Align(
                          ...
                          child: Container(
                            ...
                            height: 30,
                            width: 30,
                            child: Image.asset(Res.ic_hearfille, fit: BoxFit.cover),
                          ),
                        )),
                  ),
                ),
  ...
  Future<home.BeanHomeData> getHomeData() async {
    ...
    try {
      FormData from = FormData.fromMap({
        ...
        "mealfor": isSelect == 1 ? "0" : isSelect == 2 ? "1" : isSelect == 3 ? "2" : "1",
        "cuisinetype": "0",
        "mealtype": isSelectFood == 1 ? "0" : isSelectFood == 2 ? "1" : isSelectFood == 3 ? "2" : "0",
        "mealplan": "2",
        "min_price": "",
        "max_price": "",
        "rating": "0",
  ...
  void removeFav() async {
   ...
   getFilter() async {
    var data = await Navigator.push(context, MaterialPageRoute(builder: (_) => FilterScreen()));
    if (data != null) {
      getFilterData();
    }
  }
   ...
   getFilterData() async {
    ...
    try {
      FormData from = FormData.fromMap({
        ...
        "customer_id": "77",
        "search_location_or_kitchen": "",
        "mealfor": widget.mealfor == 1 ? "0" : widget.mealfor == 2 ? "1" : widget.mealfor == 3 ? "2" : "1",
        "cuisinetype":widget.cuisine == 1 ? "0" : widget.cuisine == 2 ? "1" : widget.cuisine == 3 ? "2" : "1",
        "mealtype": "1",
        "mealplan": widget.mealPlan == 1 ? "0" : widget.mealPlan == 2 ? "1" : widget.mealPlan == 3 ? "2" : "1",
        "min_price": 0.0,
        "max_price": 100.0,
        "rating": "0",
        "customer_address": "Devpara Rd, Charaniya, Gujarat"
